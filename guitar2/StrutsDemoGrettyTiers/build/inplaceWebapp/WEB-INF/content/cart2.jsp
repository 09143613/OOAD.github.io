...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>项目管理系统</title>
    <link href="libs/easyui/css/default.css" rel="stylesheet" type="text/css" />
    ...
    <script type="text/javascript" src="libs/easyui/js/outlook2.js"> </script>
    <script type="text/javascript">
	 ...
	 var _menus = {
		                 "menus":[
							      ...
							      "menus":[
									{"menuid":"12","menuname":"查看商品","icon":"icon-page","url":"e-goods"},
									{"menuid":"13","menuname":"增加商品","icon":"icon-class","url":"e-addGoods"},
									{"menuid":"14","menuname":"删除商品","icon":"icon-role","url":"e-delGoods"},
									{"menuid":"15","menuname":"修改商品","icon":"icon-set","url":"e-updGoods"},
									{"menuid":"16","menuname":"xxxx","icon":"icon-set","url":"NewFile"}
								    ]},
						{"menuid":"8","icon":"icon-sys","menuname":"用户管理",
							"menus":[{"menuid":"21","menuname":"查看用户","icon":"icon-nav","url":"menu2/tree2.html"},
									{"menuid":"22","menuname":"增加用户","icon":"icon-nav","url":"demo1.html"},
									{"menuid":"23","menuname":"删除用户","icon":"icon-nav","url":"demo1.html"},
									{"menuid":"24","menuname":"修改用户","icon":"icon-nav","url":"demo1.html"}
								]
